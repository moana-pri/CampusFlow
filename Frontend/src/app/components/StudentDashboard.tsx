                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="flex-1 px-4 py-2 rounded-xl bg-emerald-50 text-emerald-600 hover:bg-emerald-100 transition-colors text-sm font-medium flex items-center justify-center gap-2"
                        >
                      ...
                      <button
                        ...
                        className="w-full px-4 py-2 rounded-xl bg-red-50 text-red-600 hover:bg-red-100 transition-colors text-sm font-medium"
                      >
                        Unregister
                      </button>
                    </div>
