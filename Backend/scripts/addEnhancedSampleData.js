...
const addSampleData = async () => {
  ...
  try {
    ...
    const insertedUserIds = Object.values(usersResult.insertedIds);
    const studentId = insertedUserIds[0].toString();
    const organizerId = insertedUserIds[1].toString();
    const adminId = insertedUserIds[2].toString();
